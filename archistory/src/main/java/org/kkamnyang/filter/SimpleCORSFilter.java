...
public class SimpleCORSFilter implements Filter {
   ...
   public void destroy() {}
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    	...
    	res.setHeader("X-Frame-Options", "ALLOW-FROM http://14.32.66.127:4000/admin/imgUpload, http://14.32.66.127:4000/memberImgUpload, http://14.32.66.127:4000/admin/regist");
