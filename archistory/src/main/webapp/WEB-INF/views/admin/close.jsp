    ...
    map.addListener('click',function(event){
        ...
        geocoder.geocode({'location':event.latLng},function(result){
            ...
            if(nation == '대한민국'){
                ...
                $.post("http://14.32.66.127:4000/admin/korea",formData,function(data){$(document).replaceWith(data);});
                
            }else{
                console.log('구글지도로 다른 나라의 지도표시');
                $.post("http://14.32.66.127:4000/admin/other",formData,function(data){$(document).replaceWith(data);});
            }
