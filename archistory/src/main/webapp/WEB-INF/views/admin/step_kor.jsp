                ...
                <div class="modal-body">
                    <div id="createEventDiv" >
                       ...
                       <label for="eventName">이름</label><br>
                        ...
                        <input type="text" class="form-control" id="eventName" style="width:435px;" placeholder="이벤트 이름을 입력하세요">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="modiEventDiv">
                    ...
                    <input type="text" class="form-control" id="moeventName" style="width:435px;" placeholder="이벤트 이름을 입력하세요">
